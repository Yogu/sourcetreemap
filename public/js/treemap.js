// source: http://bost.ocks.org/mike/treemap/

function displayTreeMap(root) {
	var margin = {
		top : 20,
		right : 0,
		bottom : 0,
		left : 0
	}, width = 960, height = 500 - margin.top - margin.bottom, formatNumber = d3
	...
	var svg = d3.select("#chart")
		.append("svg")
			...
			.attr("data-aspect", svgWidth / svgHeight) // for resizing in app.js
